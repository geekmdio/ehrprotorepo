...
goog.provide('proto.ehr.noteservice.FindNoteResponse');
 ...
 * @return {!Object}
 */
proto.ehr.noteservice.FindNoteResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.ehr.noteservice.FindNoteResponse.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.ehr.noteservice.FindNoteResponse} msg The msg instance to transform.
 * @return {!Object}
 ...
 * @return {!proto.ehr.noteservice.FindNoteResponse}
 */
proto.ehr.noteservice.FindNoteResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.ehr.noteservice.FindNoteResponse;
  return proto.ehr.noteservice.FindNoteResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.ehr.noteservice.FindNoteResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.ehr.noteservice.FindNoteResponse}
 */
proto.ehr.noteservice.FindNoteResponse.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.ehr.noteservice.FindNoteResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.ehr.noteservice.FindNoteResponse.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.ehr.noteservice.FindNoteResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ehr.noteservice.FindNoteResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getStatus();
  if (f != null) {
    writer.writeMessage(
 ...
 */
proto.ehr.noteservice.FindNoteResponse.prototype.getStatus = function() {
...
proto.ehr.noteservice.FindNoteResponse.prototype.setStatus = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.ehr.noteservice.FindNoteResponse.prototype.clearStatus = function() {
