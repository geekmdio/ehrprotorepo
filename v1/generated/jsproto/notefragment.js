...
goog.forwardDeclare('proto.ehr.note.FragmentType');
goog.forwardDeclare('proto.ehr.note.RecordPriority');
...
proto.ehr.note.NoteFragment.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 9:
      ...
      break;
    case 10:
      var value = /** @type {!proto.ehr.note.RecordPriority} */ (reader.readEnum());
      msg.setPriority(value);
      break;
    case 11:
      var value = /** @type {!proto.ehr.note.FragmentType} */ (reader.readEnum());
      msg.setTopic(value);
      break;
    case 12:
      var value = /** @type {string} */ (reader.readString());
...
/**
 * optional RecordStatus status = 9;
 * @return {!proto.ehr.note.RecordStatus}
 */
proto.ehr.note.NoteFragment.prototype.getStatus = function() {
  return /** @type {!proto.ehr.note.RecordStatus} */ (jspb.Message.getFieldWithDefault(this, 9, 0));
};
...
/**
 * optional RecordPriority priority = 10;
 * @return {!proto.ehr.note.RecordPriority}
 */
proto.ehr.note.NoteFragment.prototype.getPriority = function() {
  return /** @type {!proto.ehr.note.RecordPriority} */ (jspb.Message.getFieldWithDefault(this, 10, 0));
};


/** @param {!proto.ehr.note.RecordPriority} value */
...
/**
 * optional FragmentType topic = 11;
 * @return {!proto.ehr.note.FragmentType}
 */
proto.ehr.note.NoteFragment.prototype.getTopic = function() {
  return /** @type {!proto.ehr.note.FragmentType} */ (jspb.Message.getFieldWithDefault(this, 11, 0));
};


/** @param {!proto.ehr.note.FragmentType} value */
 ...
 * @return {string}
 */
proto.ehr.note.NoteFragment.prototype.getContent = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 12, ""));
};


/** @param {string} value */
proto.ehr.note.NoteFragment.prototype.setContent = function(value) {
